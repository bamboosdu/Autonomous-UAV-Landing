/*
 * @Author: Qiang Zhou 
 * @Date: 2020-10-14 18:37:50 
 * @Last Modified by: Qiang Zhou
 * @Last Modified time: 2020-10-14 18:43:42
 * This code is used for test. It can read jpg files from a file and it will detect the marker and 
 * print the position information on the saved img.
 */
...
int main(int argc, char *argv[])
{
    ...
    String saveImg="/home/qiang/zq/git-space/drone_about/aruco_board/detect_board/build/saveImg/%d.jpg";
    ...
    ***************************************************************************/
    ...
    for (unsigned int frame = 0; frame < image_files.size(); ++frame)
	{
        ...
        **********************************************************************************************************/
        ...
        sprintf(filename,saveImg, frame);
        cout<<filename<<endl;
